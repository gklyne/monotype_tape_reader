...
m3_nut_t     = 2.0 ;    // M3 nut thickness (for recess)
m3_hinge_dia = 7.4 ;    // M3 hinge knuckle diameter
m3_csink     = 6 ;      // M3 countersink diameter
...
m4_csink     = 8 ;      // M4 countersink diameter
